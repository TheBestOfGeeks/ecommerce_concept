        ...
        children: [
              ...
              child: GridView.builder(
                physics: BouncingScrollPhysics(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 1, crossAxisSpacing: 10,mainAxisSpacing: 20, childAspectRatio: 3),
          ...
          Row(
            ...
            children: [
              ...
              Text('${cartProducts.first.total}', style: TextStyle(color: Colors.white,)),
            ],
          ),
          SizedBox(height: 10,),
          Row(
            ...
            children: [
              ...
              Text('${cartProducts.first.delivery}', style: TextStyle(color: Colors.white,)),
            ],
          ),
          SizedBox(height: 20,),
          Container(
